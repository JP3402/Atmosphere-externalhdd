...
# Linker script requirement: ams_sysmodule.ld for memory mapping.
# For UMS Redir, we must ensure the 4MB heap is correctly mapped in the User/Code region.
export LDFLAGS += -T $(TOPDIR)/ams_sysmodule.ld
